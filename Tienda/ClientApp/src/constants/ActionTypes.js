...
export const GET_ALL_FRUTAS = "GET_ALL_FRUTAS";
export const SAVE_FRUTAS = "SAVE_FRUTAS";
export const GET_ALL_VERDURAS = "GET_ALL_VERDURAS";
export const SAVE_VERDURAS = "SAVE_VERDURAS";
